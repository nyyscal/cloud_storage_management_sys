  ...
  return (
    ...
    <AlertDialogContent className='shad-alert-dialog'>
      <AlertDialogHeader className='relative flex justify-center'>
        <AlertDialogTitle className='h2 text-center'>Enter your OTP:<Image src="/assets/icons/close-dark.svg" alt="close" width={20} height={20} onClick={()=>setIsOpen(false)} className='otp-close-button'/></AlertDialogTitle>
  ...
  <InputOTPGroup className='shad-otp'>
    ...
    <InputOTPSlot index={5} className='shad-otp-slot'/>
      ...
      <AlertDialogFooter>
        ...
        <AlertDialogAction className='shad-submit-btn h-12'  type="button" onClick={handleSubmit}>Submit{isLoading &&
